...
\begin{abstract}
    Il mio progetto si pone l'obiettivo di creare un'applicazione web per la prenotazione di voli aerei di una compagnia fittizia chiamata Bryanair. L'applicazione permette di visualizzare i voli disponibili, prenotare un volo, visualizzare i dettagli di un volo e cancellare una prenotazione. L'applicazione è stata sviluppata utilizzando il framework Laravel con lo stack TALL (TailwindCSS, Alpine.js, Laravel, Livewire) e il linguaggio di programmazione PHP e il DBMS MySQL con PHPmyAdmin.
...
\begin{itemize}
    ...
    \item Alpine.js: \url{https://alpinejs.dev/}
    \item Livewire: \url{https://laravel-livewire.com/}
    \item PHP: \url{https://www.php.net/}
    \item MySQL: \url{https://www.mysql.com/}
